...
<html lang="en">
    ...
    <body class="app app--<?= getTheme() ?>">
        ...
        <ul>
            <li>
                <a href="/notes/my-problem-wit-dates-on-the-webp.php">My problem with dates on the web</a>
            </li>
            <li>
                <a href="/notes/living-life-like-a-video-game.php">Living life like a video game</a>
            </li>
            <li>
                <a href="/notes/weeknotes-1.php">Weeknotes 1</a>
            </li>
            <li>
                <a href="/notes/having-a-bike-or-rather-the-lack-of-one.php">Having a bike or rather, the lack of one</a>
            </li>
            <li>
            ...
            <li>
                <a href="/notes/writing-on-the-phone.php">Writing on the phone</a>
            </li>
            <li>
                <a href="/notes/ed-and-taking-the-time.php">Ed and taking the time</a>
            </li>
            <li>
                <a href="/notes/adult-skills.php">Adult skills</a>
            </li>
            <li>
                <a href="/notes/books-i-read.php">Books I read</a>
            </li>
            <li>
                <a href="/notes/exploring-the-small-web.php">Exploring the small web</a>
            </li>
            <li>
                <a href="/notes/my-coding-setup.php">My coding setup</a>
            </li>
            <li>
                <a href="/notes/seeing-life-through-whimsical-glasses.php">Seeing life through whimsical glasses</a>
            </li>
            <li>
                <a href="/notes/teeth-brushing.php">Teeth brushing</a>
            </li>
            <li>
                <a href="/notes/browsers.php">Browsers</a>
            </li>
        </ul>
        <hr>
        <h2>Snippets</h2>
