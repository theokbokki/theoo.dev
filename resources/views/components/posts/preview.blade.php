<div class="posts__preview">
    <div class="posts__picture">
        <button type="button" class="posts__zoom posts__zoom--preview" command="show-modal" commandfor="preview-{{ $id }}">
            <img alt="" src="{{ $file }}" class="posts__preview posts__preview--thumb"/>
        </button>
    ...
    <dialog id="preview-{{ $id }}" closedby="any" class="posts__dialog">
        ...
        <div class="posts__form posts__form--preview">
            <img src="{{ $file }}" alt="" class="posts__preview posts__preview--full" loading="lazy">
            <textarea name="preview-{{ $id }}-alt" id="preview-{{ $id }}-alt"  placeholder="Alt here..." class="posts__textarea"></textarea/>
        </div>
    </dialog>
</div>
