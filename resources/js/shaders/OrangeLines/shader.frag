...
void main() {
    ...
    float y = uv.y * 50.0 - 3.0;
    float x = uv.x * 50.0 - 300.0;
    ...
    float angleOffset = d / 3.0 - timeOffset / 8.0;
    ...
    gl_FragColor = vec4(colorIntensity / 2.0, colorIntensity / (random(uv / 2500.0)) / 10.0, colorIntensity - 30., 1.0);
}
