<div class="before:absolute before:inset-0 before:bg-neutral-200 [&:has([data-state=open])]:before:opacity-0 " data-role="nav-container">
    <div class="absolute top-40 right-16 w-44 h-44 p-2 rounded-lg bg-linear-to-b from-neutral-100/60 to-neutral-200/60 border border-neutral-200/50 backdrop-blur-xs shadow-[0_20px_20px_-20px_rgba(231,229,228,0.75)] md:hidden" data-role="mobile-nav-open">
    ...
    <nav class="p-6 m-16 rounded-xl bg-linear-to-b from-neutral-100/60 to-neutral-200/60 border border-neutral-200/50 backdrop-blur-xs shadow-[0_20px_20px_-20px_rgba(231,229,228,0.75)] transition-all duration-250 md:max-w-296 md:flex-1" data-role="nav">
